module.exports = {
  ...
  theme: {
    ...
    boxShadow: {
      ...
      outline: '0 0 0 1px hsla(228, 55%, 41%, 0.085)',
      'outline:xs': '0 0 0 1px hsla(228, 55%, 41%, 0.085), 0 1px 1px hsla(215, 75%, 36%, 4%), 0 2px 4px hsla(215, 75%, 36%, 12%)',
      'outline:sm': '0 0 0 1px hsla(228, 55%, 41%, 0.085), 0 1px 1px hsla(215, 75%, 36%, 4%), 0 4px 6px hsla(215, 75%, 36%, 12%)',
      'outline:md': '0 0 0 1px hsla(228, 55%, 41%, 0.085), 0 1px 1px hsla(215, 75%, 36%, 4%), 0 4px 12px hsla(215, 75%, 36%, 12%), 0 12px 24px hsla(215, 75%, 36%, 6%)',
      'outline:lg': '0 0 0 1px hsla(228, 55%, 41%, 0.085), 0 1px 1px hsla(215, 75%, 36%, 4%), 0 3px 6px hsla(215, 75%, 36%, 8%), 0 5px 15px hsla(215, 75%, 36%, 8%), 0 10px 30px hsla(215, 75%, 36%, 8%)',
      'outline:inner': '0 0 0 1px hsla(228, 55%, 41%, 0.125), 0 -1px hsla(228, 55%, 41%, 0.05), 0 3px 6px hsla(215, 75%, 36%, 12%) inset',
      inline: '0 0 0 1px hsla(228, 55%, 41%, 0.085) inset',
      'inline:xs': '0 0 0 1px hsla(228, 55%, 41%, 0.125) inset, 0 -1px hsla(228, 55%, 41%, 0.085) inset, 0 2px 4px hsla(215, 75%, 36%, 12%)',
      'inline:sm': '0 0 0 1px hsla(228, 55%, 41%, 0.125) inset, 0 -1px hsla(228, 55%, 41%, 0.085) inset, 0 3px 6px hsla(215, 75%, 36%, 12%)',
      'inline:md': '0 0 0 1px hsla(228, 55%, 41%, 0.125) inset, 0 -1px hsla(228, 55%, 41%, 0.085) inset, 0 3px 12px hsla(215, 75%, 36%, 12%), 0 11px 24px hsla(215, 75%, 36%, 6%)',
      'inline:lg': '0 0 0 1px hsla(228, 55%, 41%, 0.125) inset, 0 -1px hsla(228, 55%, 41%, 0.085) inset, 0 2px 6px hsla(215, 75%, 36%, 8%), 0 4px 15px hsla(215, 75%, 36%, 8%), 0 9px 30px hsla(215, 75%, 36%, 8%)',
      'inline:inner': '0 0 0 1px hsla(228, 55%, 41%, 0.085) inset, 0 3px 6px hsla(215, 75%, 36%, 12%) inset',
  ...
  variants: {
    ...
    opacity: ['responsive', 'hover', 'focus', 'interact', 'parent-interact'],
    order: ['responsive'],
