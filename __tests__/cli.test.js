...
describe('cli', () => {
  const inputCssPath = path.resolve(__dirname, 'fixtures/freehand-input.css')
  ...
  describe('init', () => {
    it('creates a Freehand config file', () => {
    ...
    it('creates a full Freehand config file', () => {
      return runInTempDirectory(() => {
    ...
    it('creates a Freehand config file in a custom location', () => {
      return runInTempDirectory(() => {
